	...
	<body>
		...
		<div id="show-location" class="content scaffold-show" role="main">
			...
			<ol class="property-list location">
				...
				<g:if test="${locationInstance?.perks}">
				<li class="fieldcontain">
					<span id="perks-label" class="property-label"><g:message code="location.perks.label" default="Perks" /></span>
					
						<span class="property-value" aria-labelledby="perks-label"><g:fieldValue bean="${locationInstance}" field="perks"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${locationInstance?.pointsRequired}">
				<li class="fieldcontain">
					<span id="pointsRequired-label" class="property-label"><g:message code="location.pointsRequired.label" default="Points Required" /></span>
					
						<span class="property-value" aria-labelledby="pointsRequired-label"><g:fieldValue bean="${locationInstance}" field="pointsRequired"/></span>
